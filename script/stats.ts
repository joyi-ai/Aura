...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/joyi-ai/Aura/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for joyi-ai/Aura...\n")
...
console.log("Fetching npm all-time downloads for @joyi-ai/Aura...\n")
const npmDownloads = await fetchNpmDownloads("@joyi-ai/Aura")
